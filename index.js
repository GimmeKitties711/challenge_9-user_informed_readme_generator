...
const questions = [ // array of objects
    {
        ...
        validate: function(answer) {
            ...
            return true; // if a title without tab characters is given
        }
    },
    {
        type: "input",
...
function writeToFile(fileName, data) {
    return fs.writeFileSync(fileName, data); // source for the writeFileSync documentation: https://nodejs.org/api/fs.html#fswritefilesyncfile-data-options
}

function processTitleString(title) {
    /*
    the purpose of this function is to filter out characters that are not allowed in filenames. as shown in this challenge's README:

    A file name can't contain any of the following characters:
    \ / : * ? " < > |

    the title is included in the file name, so if the title contains any of the forbidden characters, they need to be filtered out. I have decided to change all of them to the dash (-).
    */
...
function init() {
    // important precautions that the user should take when answering the prompts to write a new README file
