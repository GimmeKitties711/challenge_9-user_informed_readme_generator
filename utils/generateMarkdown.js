...
// the name 'The Unlicense' is the only license name that starts with the word 'The', so the purpose of this block of code is to avoid saying 'This project was created using the The Unlicense.'
  }
  return "";
}
