...
function renderLicenseSection(license) {
  ...
  if (license !== 'none') {
    return `## License
This project was created using the ${licenseFullNames[chosenLicense]} license. More information about the license can be found [here](${licenseLinks[chosenLicense]}).`;
  }
  return "";
}
